...
function init_painel(){
    ...
    set_tema('headerinc',load_css(array('foundation.min','app','jquery.dataTables.min')),FALSE);
    set_tema('footerinc',load_js(array('jquery-2.2.4','jquery','foundation.min','app','jquery.dataTables.min')),FALSE);
}
